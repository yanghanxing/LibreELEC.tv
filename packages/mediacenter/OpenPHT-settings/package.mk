...
#    fi
  ...
  python -Wi -t -B $ROOT/$TOOLCHAIN/lib/python2.7/compileall.py $INSTALL/usr/share/XBMC/addons/service.libreelec.settings/resources/lib/ -f
  rm -rf `find $INSTALL/usr/share/XBMC/addons/service.libreelec.settings/resources/lib/ -name "*.py"`

  python -Wi -t -B $ROOT/$TOOLCHAIN/lib/python2.7/compileall.py $INSTALL/usr/share/XBMC/addons/service.libreelec.settings/oe.py -f
